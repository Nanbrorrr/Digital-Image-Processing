...
Image *AverageFilt3(Image *);
Image *AverageFilt5(Image *);
...
int TestReadImage(char *filename, char *outfilename)
{
	...
	outimage = AverageFilt3(image1);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\3avegmedianbridge.pgm");
	outimage = AverageFilt3(image2);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\3avegmedianlena.pgm");

	outimage = AverageFilt5(image1);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\5avegmedianbridge.pgm");
	outimage = AverageFilt5(image2);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\5avegmedianlena.pgm");
	return(0);
}
...
Image *AverageFilt3(Image *image){
	unsigned char *tempin, *tempout;
	int size, i, j, k, t;
	Image *outimage;
...
Image *AverageFilt5(Image *image){
	unsigned char *tempin, *tempout;
	int size, i, j, k, t;
	Image *outimage;
