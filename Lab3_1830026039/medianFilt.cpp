...
Image *MedianFilt3(Image *);
Image *MedianFilt5(Image *);
...
int TestReadImage(char *filename, char *outfilename)
{
	...
	outimage = MedianFilt3(image1);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\3MedianFiltbridge.pgm");
	outimage = MedianFilt3(image2);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\3MedianFiltlena.pgm");

	outimage = MedianFilt5(image1);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\5MedianFiltbridge.pgm");
	outimage = MedianFilt5(image2);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab3_1830026039\\outimage\\5MedianFiltlena.pgm");
	return(0);
}
	...
	for (i = 1; i < image->Height - 1; ++i){
		for (j = 1; j < image->Width - 1; ++j){
			...
			for (k = -1; k < 4; ++k)
				for (t = -1; t < 4; ++t)
					local[pos++] = tempin[image->Width * (i + k) + (j + t)];
			tempout[image->Width * i + j] = findMedian(local, 25);
		}
	}
	return(outimage);
}
