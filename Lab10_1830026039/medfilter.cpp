...
int TestReadImage(char *filename, char *outfilename)
{
	...
	image = ReadPNMImage("large_septagon_gaussian_noise_mean_0_std_50_added.pgm");

	outimage = AverageFilt5(image);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab10_1830026039\\outimage\\5avegmedian.pgm");
	return(0);
}
