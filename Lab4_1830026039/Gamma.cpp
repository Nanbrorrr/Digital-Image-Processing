...
Image *Gamma(Image *image, double num);
...
int TestReadImage(char *filename, char *outfilename)
{
	...
	outimage = Gamma(image1, 0.1);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammalena0.1.pgm");
	outimage = Gamma(image1, 0.4);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammalena0.4.pgm");
	outimage = Gamma(image1, 0.6);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammalena0.6.pgm");
	outimage = Gamma(image1, 0.8);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammalena0.8.pgm");
	outimage = Gamma(image1, 1.0);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammalena1.0.pgm");

	outimage = Gamma(image2, 0.1);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammabridge0.1.pgm");
	outimage = Gamma(image2, 0.4);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammabridge0.4.pgm");
	outimage = Gamma(image2, 0.6);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammabridge0.6.pgm");
	outimage = Gamma(image2, 0.8);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammabridge0.8.pgm");
	outimage = Gamma(image2, 1.0);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab4_1830026039\\outimage\\Gammabridge1.0.pgm");
	return(0);
}
...
Image *Gamma(Image *image, double num){
	...
	for (i = 0; i < image->Height; ++i){
		for (j = 0; j < image->Width; ++j){
			int t = pow((double)tempin[i * image->Width + j] / 255.0, 1 / num) * 255.0;
			tempout[i * image->Width + j] = t;
			sum += t;
		}
	}
	float averange = sum / (image->Height * image->Width);
	double var = 0;
	for (i = 0; i < image->Height; ++i){
		for (j = 0; j < image->Width; ++j){
			var += pow((tempout[i * image->Width + j] - averange), 2) / (image->Height * image->Width);
		}
	}
	printf("%lf\n", var);
	return(outimage);
