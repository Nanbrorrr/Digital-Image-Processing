...
int TestReadImage(char *filename, char *outfilename)
{
	...
	outimage = negative(image1);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab2_1830026039\\outimage\\negativebridge.pgm");
	outimage = negative(image2);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab2_1830026039\\outimage\\negativelena.pgm");
	outimage = negative(image3);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab2_1830026039\\outimage\\negativenoise.pgm");
	return(0);
}
...
Image *negative(Image *image){
	...
	for (i = 0; i < image->Height; ++i){
		for (j = 0; j < image->Width; ++j){
			tempout[image->Width * i + j] = 255 - tempin[image->Width* i + j];
		}
	}
	return(outimage);
}