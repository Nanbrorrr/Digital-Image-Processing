...
Image *CreateNewImage(Image *, char *comment, double x);//x means the plus you want to expand
int TestReadImage(char *, char *);

Image *Near(Image *image, double x);//x means the plus you want to expand
...
int TestReadImage(char *filename, char *outfilename)
{
	...
	outimage = Near(image1, 3);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab2_1830026039\\outimage\\Nearbridge.pgm");
	outimage = Near(image2, 2);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab2_1830026039\\outimage\\Nearlena.pgm");
	outimage = Near(image3, 4);
	SavePNMImage(outimage, "C:\\Users\\94510\\Desktop\\Lab2_1830026039\\outimage\\Nearnoise.pgm");
...
Image *CreateNewImage(Image * image, char *comment, double x)
{
	Image *outimage;
	int size, j;
...
Image *Near(Image *image, double x){
	...
	double h_ratio = 1 / (double)x;
	double w_ratio = 1 / (double)x;
	int pw, ph;
